...
![Version: 2.4.6](https://img.shields.io/badge/Version-2.4.6-informational?style=flat-square) ![AppVersion: latest](https://img.shields.io/badge/AppVersion-latest-informational?style=flat-square)

Helm chart to deploy H9 Open5gs AUSF service on Kubernetes.

## Maintainers

| Name | Email | Url |
| ---- | ------ | --- |
| Jihoon Lee | <jhlee@highway9networks.com> |  |
...
| config.sbi.advertise | string | `"open5gs-ausf-sbi"` |  |
...
| image.registry | string | `"localhost:32000"` |  |
| image.repository | string | `"jlee/h9-open5gs"` |  |
